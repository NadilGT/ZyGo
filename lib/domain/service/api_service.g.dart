...
class _ApiService implements ApiService {
  ...
  @override
  Future<HttpResponse<ProfileResponseModel>> profile() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<HttpResponse<PriceResponseModel>> getPrice(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<PriceResponseModel>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/auth/pricing',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PriceResponseModel _value;
    try {
      _value = PriceResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
